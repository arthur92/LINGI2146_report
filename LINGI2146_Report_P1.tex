...
\begin{figure}
    \subfigure[Topology used : the malicious node is the mote 2 and the evolution of the radio traffic during a version number attack]{
        \includegraphics[scale=0.37]{img/versionStat2}
    }
    \includegraphics[scale=0.4]{img/versionStat}
    \caption{Traffic and consumption of resources used when a version
